...
public class DriveCommands {
    ...
    private static final double ANGLE_MAX_VELOCITY = 4;
    ...
    public static Command joystickDrive(
        ...
        return Commands.run(() -> {
            ...
            switch (Drive.mode) {
                case ORBIT:
                    Translation2d hubPose = isFlipped ? RobotConstants.redHub : RobotConstants.blueHub;
                    Pose2d robotPose = drive.getPose();
                    double dx = hubPose.getX() - robotPose.getX();
                    double dy = hubPose.getY() - robotPose.getY();
                    // +180° because fixed shooter faces backward
                ...
                case FEEDER:
                    ...
                    omega = angleController.calculate(
                            drive.getRotation().getRadians(), 
                                isFlipped ? Rotation2d.k180deg.getRadians() : Rotation2d.kZero.getRadians());
                    break;
                case NORMAL:
                default:
